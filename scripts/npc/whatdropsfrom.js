/**
 * whatdropsfrom.js — NPC script for @whatdropsfrom / @wdf
 * Opens in MONSTER search mode (find what items a monster drops).
 *
 * State machine:
...
var status;
var mobMode;     // true = mob search (whatdropsfrom), false = item search (whodrops)
var query;
var page;
...
function start() {
    status = -1;
    mobMode = true; // whatdropsfrom starts in mob mode
    query = "";
    page = 0;
    results = null;
    detailPages = null;
