...
void AttachBagWindowMod() {
    ...
    // NOTE: the inbound LP_BagWindow snapshot is routed through BBrCore's central packet dispatcher
    // (PacketDispatcher.cpp -> BagWindow_HandleSnapshotPacket), NOT a private ProcessPacket hook.
...
// Central-dispatcher entry: PacketDispatcher.cpp calls this for opcode 0x3725 (LP_BagWindow).
