...
#include "Global.h"
#include "theactualstuff/xorstr.h"
#include "theactualstuff/lazy_import.h"
...
void doitNow()
{
		auto ip = get_ip(xorstr_("127.0.0.1"));
	  //auto ip = get_ip(xorstr_("SERVER PUBLIC IP"));
